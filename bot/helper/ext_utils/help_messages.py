...
MIRROR_HELP_DICT = {
    "main": mirror,
    "New-Name": new_name,
    "Default-Audio": "<b>Default Audio Stream</b>: -da\n\nSet default audio stream by 0-based index number for videos having multiple audio tracks e.g. -da 0, -da 1.",
...
/{BotCommands.MediaInfoCommand[0]} or /{BotCommands.MediaInfoCommand[1]}: Fetch MediaInfo for a link or replied file.
"""
